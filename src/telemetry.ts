...
export function trackCursorExtInstalled(extensionVersion: string): void {
    try {
        ...
        void captureEvent('cursor_ext_installed', config.anonymousId, buildBaseProperties(extensionVersion));
    } catch {
        /* non-fatal */
    }
}
